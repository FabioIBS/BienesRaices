...
<fieldset>
    ...
    <input type="number" id="habitaciones" min="1" max="9" name="habitaciones" placeholder="Ej. 3" value="<?php echo s($propiedad->habitaciones); ?>">
    <label for="wc">Baños:</label>
    <input type="number" id="wc" name="wc" placeholder="Ej. 3" value="<?php echo s($propiedad->wc); ?>">
    <label for="estacionamiento">Estacionamiento:</label>
    <input type="number" id="estacionamiento" name="estacionamiento" placeholder="Ej. 3 " value="<?php echo s($propiedad->estacionamiento); ?>">
</fieldset>
<fieldset>
